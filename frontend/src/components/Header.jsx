            ...
            <div className={S.nav_container}>
                ...
                <div className={S.header_actions}>
                    ...
                    <a href="https://t.me/game_news_bot_1_bot" target="_blank" rel="noreferrer" className={S.tg_button}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className={S.tg_icon_svg}>
                            <path d="M22 2L2 10.5L9 13.5M22 2L15 22L9 13.5M22 2L9 13.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M9 13.5V19L12 16" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                                ...
                                {isOpen && (
                                    <div className={S.popup_menu}>
                                        <ul className={S.menu_list}>
                                            ...
                                            <li className={S.menu_item}>
                                                <NavLink to='#' className={S.navlink} onClick={() => setIsOpen(false)}>
                                                    Избранное
                                                </NavLink>
                                            </li>
                                            <li className={S.menu_item}>
                                            ...
                                            <li className={S.menu_item}>
                                                <NavLink to='/login' className={S.navlink} onClick={handleLogout}>
                                                    Выйти
                                                </NavLink>
                                            </li>
                                        </ul>
